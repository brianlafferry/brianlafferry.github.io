...
int keepers = 0 ;
	...
	*/
	...
	printf("Finished %d iterations, found %d keepers.  Best score was %0.3lf%%\n", k, keepers, best*100) ;
return 0 ;
}
...
int k = 0 ;
	...
	if (margerror > 0)
		printf("%lf\n", margerror) ;	// Apparently margerror is always negative
